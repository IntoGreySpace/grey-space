...
We organize our discussion of the relationship between social needs and personality factors in terms of the scientifically validated _big-five_ factor framework, which can be encoded using the OCEAN acronym: Openness, Conscientiousness, Extraversion, Agreeableness, and Neuroticism ([[@McCraeCosta97]]; [[@McCraeCostaMartinEtAl04]]). We also reference the ever-popular Myers-Briggs Type Inventory (MBTI) framework that is based closely on Jung's framework, which has 4 factors, two of which align well with the Openness and Extraversion / Introversion factors from the big five. 

### Introversion / extraversion

One of the most widely-identified and scientifically-supported personality factors is **introversion** vs. **extraversion**, which were introduced by Jung, and are also central to the MBTI. In general, introverts find social interaction draining, while extroverts find it energizing.

There can be many factors that drive this difference, from factors that influence the general biases that others have toward an individual (e.g., attractiveness, physical or mental abilities, etc), broader motivational factors such as an overall approach vs. avoid bias, and the extent of predictive learning and understanding about why people behave in the ways that they do: if people are more predictable, then social interaction is experienced as less effortful.

One's status on this dimension has clear implications for the ability to satisfy the primary _inclusion_ need, with introverts in general experiencing less of a feeling of inclusion.

The space of all the ways in which one can end up on this dimension, including developmental trajectories, is large and complex. For example, most people think that I am an extravert, but I was extremely shy as a child, and only became more extraverted as I was able to understand and predict people's behavior better. I was also lucky to be relatively attractive and intelligent, so that helped with overall feelings of inclusion and respect. Nevertheless, I still do not experience a strong intrinsic need to be around other people, which perhaps differentiates me from others who were more "born extraverts".

### Conscientiousness

Conscientiousness does not map well into the MBTI / Jung framework. People who are high on this factor are strongly driven by the _trust_ social need, and in general are willing to put the needs of others ahead of their own, which also helps to achieve greater _inclusion_ and _respect_. Thus, aside from the control and nurturing needs, conscientiousness may index the overall individual differences in the strength of the social needs: where these needs are strong, they can then out-compete against other individual needs, and a general desire to not exert as much effort. People who are lower on this dimension tend to emphasize their own individual needs more, and are not as constrained by the social needs.

Because the big-five factors are specifically designed to capture _orthogonal_ dimensions of variance, an individual could be high in conscientiousness but not an extravert, for example: they need others to trust, respect, and include them, but they don't necessarily want to spend their time interacting with others.

### Agreeableness

Agreeableness does not map well into the MBTI / Jung framework. In terms of social needs, it reflects the _control_ dimension, particularly in the direction of the group influence over the individual. Someone who is highly agreeable is willing to cede more of their own sense of individual control to that of the group, perhaps as a way of gaining greater inclusion. But they may not obtain greater trust or respect from this, if they are perceived as being a _sycophant_ who is being agreeable as a means to an end.
...
The final big-five factor is neuroticism, which reflects a tendency toward anxiety, and also more highly variable emotional responses more generally. It is also considered a more _basic_ temperament factor, associated with the fundamental approach vs. avoid dimension that underlies both openness and extraversion-introversion. As noted in those cases above, the orthogonality of the mature individual's personality factors can arise from developmental processes that run counter to this more basic temperament factor.

In terms of social needs, higher neuroticism may be associated with a higher need to interact with trustable others.
...
* Hufflepuff: are the hard-working, friendly, cooperative, "salt of the earth" kind of people. In terms of the big-five factors, they are high in conscientiousness and agreeableness, with less clear loadings on the other factors. From the social needs perspective, this means that they have overall strong social needs, particularly with respect to inclusion and trust, and are more willing to cede their own control to others.

* Gryffindor: are the overall "good guys" in the Harry Potter world, naturally because that is where all the protagonists are. Interestingly, they are generally low on conscientiousness, reflecting more of a "lone wolf" kind of approach (low social needs), and a reliance on their own personal integrity and bravery. Thus they are essentially an opposite pole to the Hufflepuff. They are probably overall higher on openness, having a sense of adventure and an ability to quickly understand and appreciate threats and opportunities, but in general the low conscientiousness would make them more "street smart" than "book smart". They may be somewhat low on agreeableness, or perhaps can assert higher levels of social control while not being low on agreeableness, to the extent that they are put in a leadership position. They may gain respect and trust to the extent that they are seen as having their own strong internal compass (similar to the low agreeableness case).
